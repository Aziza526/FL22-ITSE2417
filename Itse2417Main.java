...
public class Itse2417Main {
    ...
    /**
     * For the menu array, replace FinalProj with the name of your class Please
     * make sure that you (1) DO NOT DELETE keyword new (Your class has to be
     * instantiated) (2) Put your code on the correct line See Entry 22 for an
     * example.
     *
     * Notes: Your class will be named Lastname.java Use FinalProj.java as your
     * starting code template. @see FinalProj.java Can contain menus. If you
     * need a Scanner from keyboard, use Itse2417Main.myScan, a static Scanner
     * provided by the main menu program. Using your own, local Scanner will
     * cause problems for everyone. Will be implementing the begin() method of
     * the FinalProject interface. @see FinalProject.java Do whatever you want
     * inside begin(). Main requirement: your program must end cleanly and
     * return to Itse2417Main to display the menu.
     */
    ...
    /**
     * Starting point for the program. Displays the menu list as selected by the
     * user Executes the entry in the
     *
    ...
    /**
     * Displays the user menu, a list of students in the class numbered. User
     * selects a number, which is converted to int and returned to main.
     *
